...
1. Read `/Users/halic/Installed/geo-sonification/DEVLOG.md` section `Recording Guide`.
2. Read the latest relevant `DEVLOG` entries for the milestone you are touching (`docs/devlog/M1|M2|M3`).
3. If you are modifying docs structure, confirm naming/index rules in `DEVLOG.md` before editing.
...
3. Add/update the link in `/Users/halic/Installed/geo-sonification/DEVLOG.md` under `## Entries`.
