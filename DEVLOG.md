...
- `docs/2026-02-21-OPEN-PLATFORM-SPEC.md` — REQ-ALERT-001, AlertRule type, alert_rules.json, M3/M4 scope, decision locks, future work, performance envelope (10 edit zones)
- `docs/2026-02-21-MIGRATION-PLAN.md` — M3 scope/DoD/evidence, M4 UI→API, risk register, future work, traceability matrix (15 edit zones)
- `docs/2026-02-22-IMPLEMENTATION-GUIDE.md` — Section 9 compound semantics, M3-A/M4-B packets, effort matrix, pitfall checklist, scaling boundary, dependencies (11 edit zones)
