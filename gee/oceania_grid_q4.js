...
Export.table.toDrive({
  collection: results, description: 'oceania_grid_q4', folder: 'geo_sonification',
  fileNamePrefix: 'oceania_grid_q4', fileFormat: 'CSV',
  selectors: [
    'grid_id', 'lon', 'lat',
    'landcover_class',
