// ========== South America Grid (MVP: landcover + nightlight + population) ==========
// Paste into GEE Code Editor and run. Data vintage: 2020-2021.

var region = ee.Geometry.Rectangle([-82, -56, -34, 13]);
var gridSize = 0.5;
// Tuning knobs
...
var lonList = ee.List.sequence(-82, -34 - gridSize, gridSize);
var latList = ee.List.sequence(-56, 13 - gridSize, gridSize);
...
// print('South America grids:', results.size());  // Skip .size() to avoid memory limit on large regions
Map.centerObject(region, 3);
Export.table.toDrive({
  collection: results, description: 'south_america_grid', folder: 'geo_sonification',
  fileNamePrefix: 'south_america_grid', fileFormat: 'CSV',
  selectors: [
    'grid_id', 'lon', 'lat',
    'landcover_class',
